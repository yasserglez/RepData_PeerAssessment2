...
ggplot(population_data, aes(x = event_type, y = damage_count, fill = event_type)) +
    geom_bar(stat = "identity") +
    coord_flip() +
    facet_grid(damage_type ~ .) +
    theme(legend.position = "none") +
    labs(title = "Damages to Population Health",
...
ggplot(economy_data, aes(x = event_type, y = total_damages, fill = event_type)) +
    geom_bar(stat = "identity") +
    coord_flip() +
    theme(legend.position = "none") +
    labs(title = "Damages to the Economy",
         x = "Event type", y = "Damages (dollars)")
```
